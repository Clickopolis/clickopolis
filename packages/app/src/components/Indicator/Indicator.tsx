...
function determineSignColor(
  v: any,
  positiveColor: string,
  negativeColor: string = '#ff6347',
  neutralColor: string = '#222'
) {
  if (typeof v === 'number') {
    if (v > 0) {
    ...
    <div>
      {label != null ? (
        <div
          ...
          className="clickopolis-indicator-label"
        >
          {label}
        </div>
      ) : null}
      <div
        ...
        style={{
          backgroundColor: determineSignColor(
            value,
            positiveColor,
            negativeColor,
            neutralColor
      ...
      >
        ...
        {value != null && (
          <span
            style={{ margin: '.25rem' }}
            className="clickopolis-indicator-value"
          >
            {ff(value, formatFunction)}
          </span>
        )}
      </div>
    </div>
