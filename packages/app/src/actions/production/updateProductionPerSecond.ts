...
export type updateProductionPerSecond = (
  a: number
) => Action<UPDATE_PRODUCTION_PER_SECOND>;
...
export type updateProductionPerClick = (
  a: number
) => Action<UPDATE_PRODUCTION_PER_CLICK>;
...
export const UPDATE_MAX_PRODUCTION: UPDATE_MAX_PRODUCTION =
