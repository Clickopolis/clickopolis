			...
			<nav className="clickopolis-menu">
				...
				<div className={css.quickView}>
					...
					>
						...
						<FontAwesomeIcon
							className={css.quickViewChevron}
							icon={this.state.isQuickViewOpen ? faChevronUp : faChevronDown}
						/>
					</h3>
					<div
						style={{
				...
				<nav className="main-nav">
						...
						{menus.map((menu) => {
							return (
								<li
									...
									className={classes(
										css.menuItem,
										this.props.currentMenu === menu.name && css.menuItemSelected
									)}
								>
					...
					<div className={css.debugPanel}>
						...
						<br />
						<Button style={{ background: '#333' }} onClick={() => this.props.resetAdvancements()}>
							Reset Advancements
						</Button>
						<div
