...
export class CitizensScreenBase extends React.Component<
  CitizensScreenProps,
  CitizenScreenState
> {
      ...
      >
        <div className="citizens-top-bar" style={{ height: '64px' }}>
          <Indicator
            ...
            style={{
              background:
                this.getEmploymentRatio() >= 1 ? 'lightgreen' : 'tomato',
            }}
        ...
        <div className="citizens-note">
          ...
          <img className="tiny-image" src="./images/cash.svg" />
          ...
          Each citizen also consumes 1{' '}
          <img className="tiny-image" src="./images/food.svg" />
          PS
        </div>
      </Screen>
    );
