		...
		<div className={classes(css.biomesScreen)}>
			...
			<div style={{ display: 'flex' }}>
				...
				>
					...
					<div className={css.biomeDominance}>Dominant Biome: {'Desert'} (95% of land)</div>
				</div>
				{
					<div className={classes(css.biomeData, !currentBiomeData && css.biomeDataHidden)}>
						<div className={css.biomeName}>{currentBiomeData?.name ?? 'Select a Biome'}</div>
						{currentBiomeData ? (
							<div className={css.biomeRankWrapper}>
								<div className={css.biomeRank}>Rank: {currentBiomeData?.biomeRank}</div>
						...
						<div className={css.biomeRankItems}>
							{currentBiomeData?.rankBonuses &&
								currentBiomeData?.rankBonuses.map((rankBonus: any, idx: number) => (
									<div
										style={{
